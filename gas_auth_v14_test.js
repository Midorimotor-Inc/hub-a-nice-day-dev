...
// 13.5) 招待メール（管理者が押す）
{
  ...
  t('招待にテスト版の入口URLが入る', m.body.indexOf('hub-a-nice-day-test/')>0);
  t('DEVの件名は「みどりモータース スケジュールシステム テスト版【Hub a Nice Day】」で始まる', m.sub.indexOf('みどりモータース スケジュールシステム テスト版【Hub a Nice Day】')===0, m.sub);
  sentMail=[];
